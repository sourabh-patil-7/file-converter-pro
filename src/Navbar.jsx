      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:w-8/12">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="ml-4 flex items-center md:ml-6">
            <a href="https://github.com/sourabh-patil-7/file-converter-pro"  target="_blank" className="text-white bg-orange-600 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
              GitHub
            </a>
          </div>
